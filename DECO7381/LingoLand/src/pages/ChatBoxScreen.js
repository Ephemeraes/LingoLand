...
export default function ChatBoxScreen() {
    ...
    useFocusEffect(
        React.useCallback(() => {
            setMessages([{ id: 1, text: 'Hi, what can I help you with?', sender: 'bot' }]);
            setIsNewTopic("true");
        }, [])
    );
    ...
    const sendMessage = () => {
        if (message.trim() !== '') {
            fetch('http://192.168.31.40:8082/api/chatgpt/send', {
                method: 'POST',
                ...
                .then((data) => {
                    if (data.status === 'success') {
                        setMessages([
                            ...
                            { id: messages.length + 2, text: data.response, sender: 'bot' },
                        ]);
                        setIsNewTopic("false");
                    }
                })
        ...
        >
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerContainer}>
                    <Text style={styles.headerText}>Chat Box</Text>
